          ...
          {experiences.map((exp, i) => (
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 0.5s ease, transform 0.5s ease, border-color 0.2s ease",
              }}
              onMouseEnter={(e) => {
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6.75h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h18"
                        />
                      </svg>
                    </div>
                  )}
