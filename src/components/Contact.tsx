          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">singhalsaransh40@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">github.com/Saransh1650</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">linkedin.com/in/saransh-singhal-359082238</p>
              </div>
            </div>
          </div>
        </div>
