  ...
  const ProjectCard = ({ project }: { project: Project }) => (
    ...
    >
      ...
      <div className="relative h-48 bg-gradient-to-br from-purple-500/10 via-teal-500/10 to-purple-500/5 overflow-hidden">
        ...
        <div className={`absolute inset-0 bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-sm flex items-center justify-center gap-4 transition-all duration-300 ${
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-semibold text-gray-300 uppercase tracking-wider">Tech Stack</h4>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-700/50">
          <span className="text-xs text-gray-500 capitalize font-medium">
            {project.category.replace('opensource', 'open source')}
          </span>
