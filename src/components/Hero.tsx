...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center relative z-10 transition-all duration-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        {/* Greeting */}
        <div className="mb-4 sm:mb-6">
          <span className="text-purple-400 text-base sm:text-lg font-medium">
            Hello, I&apos;m
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16">
          {socialLinks.map((link, index) => (
            <a
              ...
              } text-white px-6 py-3 rounded-lg font-semibold flex items-center gap-2 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300`}
            >
              {link.icon}
              {link.name}
            </a>
